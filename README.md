...
## Organização
- [diagrams](diagrams): Nesse diretório está o [diagrama relacional](diagrams/DiagramaVenda_Carro.pdf) (lógico) do sistema.
...
- [src](src): Nesse diretório estão os scripts do sistema
    ...
    * [model](src/model/): Nesse diretório encontram-ser as classes das entidades descritas no [diagrama relacional](diagrams/DiagramaVenda_Carro.pdf)
